...
export const DeliveryForm: FC<TDeliveryFormProps> = ({ form }) => {
    ...
    const regions = useMemo(
        () =>
            RegionesYComunas.regiones.map((reg: any) => ({
                value: reg.region,
                label: reg.region,
            })),
        []
        ...
        () =>
            regionWatch
                ? (RegionesYComunas.regiones
                      .find((reg: any) => reg.region === regionWatch.value)
                      ?.comunas.map((city: any) => ({
                          value: city,
                          label: city,
                      })) ?? [])
                : [],
